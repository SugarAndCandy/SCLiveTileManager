Pod::Spec.new do |s|
  ...
  s.homepage = 'http://gitlab.sugarandcandy.ru/iOS/SCLiveTileManager'
  s.social_media_url = 'https://twitter.com/sugarandcandyru'
  s.authors  = { 'Sugar and Candy' => 'hi@sugarandcandy.ru' }
  s.source   = { :git => 'https://github.com/SugarAndCandy/SCLiveTileManager.git', :tag => s.version, :submodules => true }
  s.requires_arc = true
  s.platform     = :ios, "8.0"
